 ...
 * @author Richard
 */
public class AddDnsRecordResponse {

  public static AddDnsRecordResponse parse(InputStream is) throws IOException {
    ObjectMapper objectMapper = new ObjectMapper();
    objectMapper.disable(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES);
    return objectMapper.readValue(is, AddDnsRecordResponse.class);
  }
